const styles = {
    ...
    heading3: "font-lato font-light xs:text-[20px] text-[20px] text-white xs:leading-[150%] leading-[150%] w-full",
  ...
  export const layout = {
    ...
    sectionImg: `flex flex-1 ${styles.flexCenter} xs:ml-10 ml-2 md:mt-0 mt-10 relative`,
